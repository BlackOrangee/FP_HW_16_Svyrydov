...
int DataDays(int months[], int SIZE_MONTHS, int month, int data_days, int day);
...
int main()
{
	...
	first_data_days = DataDays(months, SIZE_MONTHS, month_1, first_data_days, day_1);

	//Calculate how many days have passed in a year until the end date
	second_data_days = DataDays(months, SIZE_MONTHS, month_2, second_data_days, day_2);
